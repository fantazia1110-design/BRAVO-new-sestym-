...
const fullNavItems: NavItem[] = [
  { label: 'لوحة التحكم', tab: undefined, icon: <LayoutDashboard size={20} />, color: 'text-violet-500' },
  { label: 'المواد الخام', tab: 'raw', icon: <FlaskConical size={20} />, color: 'text-violet-400' },
  { label: 'الموردون', tab: 'suppliers', icon: <Truck size={20} />, color: 'text-purple-400' },
  { label: 'التركيبات', tab: 'formulas', icon: <Beaker size={20} />, color: 'text-purple-500' },
  { label: 'معمل التركيبات', tab: 'formula-lab', icon: <Sparkles size={20} />, color: 'text-violet-500' },
  ...
  { label: 'المخزون', tab: 'inventory', icon: <Warehouse size={20} />, color: 'text-violet-500' },
  { label: 'المبيعات', tab: 'sales', icon: <ShoppingCart size={20} />, color: 'text-fuchsia-500' },
  { label: 'الفواتير', tab: 'invoices', icon: <FileText size={20} />, color: 'text-purple-400' },
  { label: 'العملاء', tab: 'customers', icon: <Users size={20} />, color: 'text-violet-400' },
  { label: 'المديونيات', tab: 'debts', icon: <CreditCard size={20} />, color: 'text-fuchsia-500' },
  { label: 'المصروفات', tab: 'expenses', icon: <Receipt size={20} />, color: 'text-purple-500' },
  { label: 'التقارير', tab: 'reports', icon: <BarChart3 size={20} />, color: 'text-violet-500' },
  { label: 'الأكاديمية', tab: 'academy', icon: <GraduationCap size={20} />, color: 'text-fuchsia-400' },
  { label: 'الكتب الرقمية', tab: 'books', icon: <BookOpen size={20} />, color: 'text-fuchsia-500' },
  { label: 'الإعدادات', tab: 'settings', icon: <Settings size={20} />, color: 'text-purple-400' },
];
