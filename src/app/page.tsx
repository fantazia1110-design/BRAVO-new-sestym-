...
export default function DashboardPage() {
  return (
    <div className="space-y-8">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", width: "100%", alignContent: "stretch" }}>
        {/* المنتجات الأكثر مبيعاً */}
        <div className="card list-card animate-slide-up" style={{ animationDelay: '0.7s', minWidth: 0, animationFillMode: 'both', height: '100%' }}>
        ...
        {/* آخر التركيبات */}
        <div className="card list-card animate-slide-up" style={{ animationDelay: '0.8s', minWidth: 0, animationFillMode: 'both', height: '100%' }}>
          <div className="card-header flex items-center justify-between">
            <h2 className="text-2xl font-extrabold flex items-center gap-3">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", width: "100%", alignContent: "stretch" }}>
        {/* آخر عمليات التصنيع */}
        <div className="card list-card animate-slide-up" style={{ animationDelay: '0.9s', minWidth: 0, animationFillMode: 'both', height: '100%' }}>
          <div className="card-header flex items-center justify-between">
            <h2 className="text-2xl font-extrabold flex items-center gap-3">
        ...
        {/* آخر الفواتير */}
        <div className="card list-card animate-slide-up" style={{ animationDelay: '1s', minWidth: 0, animationFillMode: 'both', height: '100%' }}>
          <div className="card-header flex items-center justify-between">
            <h2 className="text-2xl font-extrabold flex items-center gap-3">
